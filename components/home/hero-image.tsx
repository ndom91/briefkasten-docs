...
import Screenshot from "../../public/screenshots/feed_hero-dark.png"
import ScreenshotLight from "../../public/screenshots/feed_hero-light.png"
...
export const HeroImage = () => {
  return (
    <div className="hidden overflow-hidden absolute right-0 top-12 p-px max-w-screen-sm rounded-md shadow-md transition duration-300 ease-in-out lg:block hover:shadow-xl w-[30vw] rotate-[9deg] group gradient-23 dark:gradient-33 hover:translate-y-[2vw] hover:rotate-[3deg] hover:scale-[1.3]">
      ...
      <Image
        className="inline-block relative bg-black bg-cover rounded-md opacity-0 transition dark:p-1 dark:opacity-100 gradient-border object-fit size-0 dark:size-fit"
        src={Screenshot}
