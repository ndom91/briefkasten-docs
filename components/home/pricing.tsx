export function Pricing() {
  return (
    <section>
      <div className="container relative items-center mx-auto w-full md:px-12 lg:px-16">
        ...
        <div>
          <div className="overflow-hidden relative p-3 space-y-12 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:p-10 lg:space-y-0">
            <div className="p-2 rounded-xl border backdrop-blur shadow-xs dark:border-neutral-800">
              <div className="flex relative flex-col p-8 bg-gray-200 rounded-lg border dark:border-neutral-600">
            ...
            <div className="p-2 rounded-xl border backdrop-blur shadow-xs dark:border-neutral-800">
              <div className="flex relative flex-col p-8 rounded-lg border bg-neutral-700 dark:border-neutral-600">
