...
|      <ImageZoom alt="Login" src={app0} />      | <ImageZoom alt="Dashboard" src={app1} /> |
| :--------------------------------------------: | :--------------------------------------: |
|                  Login Screen                  |                Dashboard                 |
|    <ImageZoom alt="Quick Add" src={app2} />    |   <ImageZoom alt="Edit" src={app5} />    |
|                   Quick-Add                    |              Edit Slide-Out              |
| <ImageZoom alt="Empty Dashboard" src={app8} /> |
|                Empty Dashboard                 |
