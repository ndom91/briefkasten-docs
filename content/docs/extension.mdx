...
<Screenshot src={Extension} alt="Extension" className="shadow-xs" />
...
<Screenshot src={Extension2} alt="Extension" className="shadow-xs" />
...
<Callout type="info" title="Tip" className="shadow-xs">
