...
The full database schema can be found in the repository under [`/apps/{web,backend}/prisma/schema.prisma`](https://github.com/ndom91/briefkasten/blob/main/apps/web/prisma/schema.prisma)
